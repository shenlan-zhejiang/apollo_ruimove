...
class RuimoveController final : public VehicleController {
 public:

  explicit RuimoveController() {};

  virtual ~RuimoveController();
 ...
 private:
  // control protocol
  Vcuctrl12a1* vcu_ctrl1_2a1_ = nullptr;
  Vcuctrl22a2* vcu_ctrl2_2a2_ = nullptr;
